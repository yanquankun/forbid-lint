...
export function getIVersionChoices(currentVersion: string): IVersionChoice[] {
  ...
  let IVersionChoices: IVersionChoice[] = [
    {
      title: "next",
  ...
  IVersionChoices.push({ value: "custom", title: "custom" });

  IVersionChoices = IVersionChoices.map((i) => {
    i.title = `${i.title} (${i.value})`;
    return i;
  });

  return IVersionChoices;
}
